...
int convert(char old)
{
	//上下左右
	if(old==0x48) return 0x40000052;		//上
	if(old==0x50) return 0x40000051;		//下
	if(old==0x4b) return 0x40000050;		//左
	if(old==0x4d) return 0x4000004f;		//右
