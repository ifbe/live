...
{
	u32 type = *(u32*)0x2008;
	if(type == 0xb8000)entityread_b8000();
	else if(type == 0xa0000)entityread_a0000();
	else entityread_image();
}
void entitywrite(u64 key, u64 type)
{
	if(type == 0x64626b)
	{
		if(key == 0x1b)		//esc
